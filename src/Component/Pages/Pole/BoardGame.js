import rpgGames from "../../../images/logoBoard.png";
import split from "../../../images/split.png";
import {Link} from "react-router-dom";
import {GAME_LIST_URL} from "../../../Constant";
import {Header} from "../../Header";

export const BoardGame = () => {
    // TODO: BoardGame description
    return (
        <>
            <Header />
            <div className={'flex flex-col items-center justify-center w-full'}>
                <div className={'flex flex-col items-center justify-center w-3/4'}>
                    <h1 className={'text-8xl mt-8 text-center font-zelda'}>Boardgames</h1>
                    ...
                    <div className={'h-48 w-1/2 relative m-10 hidden lg:block overflow-hidden'}>
                        ...
                        <div className={"flex flex-row h-full justify-center relative items-center z-50"}>
                            <Link to={GAME_LIST_URL+'/BoardGame'}>
